...
public class Exo2 {
	...
	public static void execute() {
		...
		Tache s6 = new Tache("Menuiseries intérieures", 8, 50, 30); G.addVertex(s6);
		Tache s7 = new Tache("Menuiseries extérieures", 3, 50, 40); G.addVertex(s7);
		Tache s8 = new Tache("Plâtres", 3, 80, 30); G.addVertex(s8);
